class ItemsController < ApplicationController
  ...
  def index
    #@items = Item.all
	@items = Item.order(:content).page params[:page] 
 # if params[:search]
 ...
 def search
  ...
  if params[:search]
	...
	#@items = Item.simple_search(params[:search_string])
	#	render :action => "index"
  ...
  private
    ...
    def item_params
      params.require(:item).permit(:content, :done, :img_url, :description, :price)
    end
